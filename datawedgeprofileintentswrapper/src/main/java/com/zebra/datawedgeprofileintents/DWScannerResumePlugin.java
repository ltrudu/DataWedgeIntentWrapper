...
public class DWScannerResumePlugin extends DWProfileCommandBase {
    ...
    public DWScannerResumePlugin(Context aContext) {
        super(aContext);
    }
    ...
    public void execute(DWProfileBaseSettings settings, onProfileCommandResult callback)
    {
        ...
        {{
            mPackageName = DWScannerResumePlugin.this.mContext.getPackageName();
        ...
        sendDataWedgeIntentWithExtraRequestResult(DataWedgeConstants.ACTION_DATAWEDGE_FROM_6_2,
                DataWedgeConstants.EXTRA_SCANNERINPUTPLUGIN_FROM_6_3, DataWedgeConstants.DWAPI_PARAMETER_SCANNERINPUTPLUGIN_RESUME);
